...
def main():
    ...
    conversation_generator = gen(dataset, bot.sequence_length, batch_size=10) # batch_generator(dataset, bot.sequence_length, batch_size=20)
    bot.fit_generator(conversation_generator, samples_per_epoch=50000, nb_epoch=50)
